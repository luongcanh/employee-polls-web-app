...
import { formatTime } from '../../redux/utils/common';
...
const Question = ({ question }) => {
	...
	/**
	 * @description Handle the "Show" button click event
	 */
		...
		<Paper elevation={5} >
			<Box sx={{ minWidth: 275 }}>
				<Card variant="outlined">
					...
					<CardActions sx={{ justifyContent: 'center', borderTop: '1px solid rgba(0, 0, 0, 0.3)', px: 4, py: 2, }}>
